if Config.ScrapyardSearching.Enable then if Config.Debug then print("^5Debug^7: ^2Loading^7: '^6Scrapyard Searching^7'") end
    ...
    for k, v in pairs(Config.ScrapyardSearching.models) do
        exports.interact:AddModelInteraction({
            model = v,
            offset = vec3(0.0, 0.0, 0.0), -- optional
            id = 'jimrecycle:scrapyard', -- needed for removing interactions
            ...
            options = {
                {
                    ...
                    action = function(entity, coords, args)
                        TriggerEvent("jim-recycle:Scrap:Search", { entity = entity })
                    end,
                },
            }
        })
